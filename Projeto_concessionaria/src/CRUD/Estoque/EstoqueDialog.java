...
public class EstoqueDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Controle de Estoque");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Quant. Estoque", "Quant. Max.", "Quant. Mín."
            }
        ));
        ...
        jLabel15.setText("Editar estoque...");
        ...
        jLabel2.setText("Cadastro de Nova Entrada");
    ...
    private void jLabel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MouseClicked
        if(editaEstoque == null || !editaEstoque.isDisplayable()){
            EditaEstoque edita = new EditaEstoque(null, false, user);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstoqueDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
